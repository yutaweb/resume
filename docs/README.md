...
Amazon Connectでのコールセンターの設計・開発・テスト・運用。
- **プロジェクト規模：**
    - 平均 2〜3 人チームでの開発
- **役割：**
    - 機能検討、設計、コーディング、レビュー、テスト、運用
...
|AWS CLF|<div data-iframe-width="150" data-iframe-height="270" data-share-badge-id="a8e4fca2-cb9b-4131-9023-2b413dffd3c6" data-share-badge-host="https://www.credly.com"></div><script type="text/javascript" async src="//cdn.credly.com/assets/utilities/embed.js"></script>|
|AWS DVA||
|AWS SAA||
